...
['git ls-files [path] | grep \'\.java$\' | xargs git add', '# git: add all *.java files under given path; must not be a bare repo'],
['git init gitDir',                               '# git: create bare repo in the gitDir'],
['git --git-dir=gitDir add "src/**/*.java"',      '# git: recursivelly add all *.java files from src/ to a repo located in gitDir'],
