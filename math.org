...
*** Functions: (Sets and functions between sets)
    ...
    |------------+----------------------+--------------------------+----------|
    | injective  | monic / monomorphism | distinct Xs → distinc Ys | Faithful |
    | surjective | epic / epimorphism   | every elem in Y is used  | Full     |
    |            |                      |                          |          |


    Constant functor - collapses every obj into 1 obj and every morphism into an identity
