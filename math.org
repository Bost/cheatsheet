...
* Instaparse - Build parsers in clojure: context-free grammars were as easy to use as regexs
...
Predicate is a proposition whose truth depends on the values of variable(s).

** Proof Theory
   Proof of soundness, proof of completeness
