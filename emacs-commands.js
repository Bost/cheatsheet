...
['M-x ucs-insert RET 2211',         '; unicode: insert unicode char upper-case sigma U+2211 ∑'],
['M-x hs-minor-mode, C-c @ C-c',    '; folding: enable folding, fold / unfold'],
['za(A) / zc(C) / zm / zo(O) / zC zO zA / zR','; folding: toggle / close / close all / , open, toggle current / all folds from cursor/ all folds'],
...
['M-x finder-by-keyword',           '; packages grouped by keyword'],
...
['C-c ?',                           '; helm: manual'],
['M-x helm-top / M-x proced',       '; helm: htop: top: linux:'],
