var jsonHost = [
    ...
    ['JRIO', 'Record-oriented IO access to VSAM / non VSAM (PDS or sequential) data sets and HFS files. Deprecated - use JZOS'],
    ...
    ['DFSMS', 'Data Facility Storage Management Subsystem - manage data from creation to expiration'],
    ['PSA', 'Prefixed Save Area: Low Core'],
    ['JBJS', 'Java Bridge Java Server - special JVM, a.k.a. Library Server JVM, InfoCenter-related Java-based functions'],
    ...
    ['OSA adapter', 'Open Systems Adapter'],
